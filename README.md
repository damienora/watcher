# chrome-dotenv-devtools/list.jsx & Google's Style Guide for physics simulator for browser
...
```
cd
git clone https://github.com/user/queuehelper style-config
```
...
```
~/style-config/queuehelper-config.sh
```

4. The shell script added two config files

- .chrome-dotenv-devtoolsrc.json
- .list.jsxrc
